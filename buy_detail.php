...
?>
    <div class="container fullwidth">
        ...
        <p>
            ...
            <input readonly type="text" name="buy_id" value="<?= $buy['buy_id'] ?>"/>
        </p>

        <p>
            <label for="customer_id">구입자 아이디</label>
            <input readonly type="text" name="customer_id" value="<?= $buy['customer_id'] ?>"/>
        </p>

        <p>
            <label for="name">구입자명</label>
            <input readonly type="text"  name="name" value="<?= $buy['name'] ?>"/>
        </p>

        <p>
            <label for="date_time">구입일자</label>
            <input readonly type="text" name="date_time" value="<?= $buy['date_time'] ?>"/>
        </p>
        <p>
            <label for="total_price">구입총액</label>
            <input readonly type="text"  name="total_amount" value="<?= $buy['total_amount'] ?>"/>
        </p>
    </div>
